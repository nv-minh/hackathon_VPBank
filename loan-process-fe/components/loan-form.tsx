...
export function LoanForm() {
  ...
  return (
    <section id="loan-form" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Đăng Ký Khoản Vay</h2>
            <p className="text-xl text-gray-600">Điền thông tin để nhận tư vấn và báo giá tốt nhất</p>
          </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-green-600">6.5%/năm</span>
                    </div>
                    <div className="flex justify-between">
