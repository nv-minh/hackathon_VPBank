      ...
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-4xl font-bold text-vp-green">
              Đăng Ký Vay Vốn Trực Tuyến
            </h2>
            <p className="text-xl text-gray-600">
              Hoàn tất biểu mẫu trong 2 phút để bắt đầu
            </p>
          </div>
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    <FileText className="w-5 h-5 mr-2 text-vp-green" />
                    Thông Tin Đăng Ký
                  </CardTitle>
                  <CardDescription>
                    Vui lòng cung cấp thông tin chính xác để được hỗ trợ tốt
                    nhất
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        <Label className="mb-2" htmlFor="loanAmount">
                          Số Tiền Vay (VNĐ) *
                        </Label>
                        <Input
                          id="loanAmount"
                      ...
                      <div>
                        <Label className="mb-2" htmlFor="monthlyIncome">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                      <div>
                        <Label className="mb-2" htmlFor="loanPurpose">
                          Mục Đích Vay *
                        </Label>
                        <Select
                          onValueChange={(value) =>
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-vp-green hover:bg-vp-green-dark"
                      size="lg"
                    >
                      Gửi Đăng Ký
                    </Button>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    <Calculator className="w-5 h-5 mr-2 text-vp-green" />
                    Ước Tính Khoản Vay
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Lãi suất từ:</span>
                      <span className="font-semibold text-vp-green">
                        6.5%/năm
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Thời hạn vay:</span>
                      <span className="font-semibold">1-20 năm</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Hạn mức tối đa:</span>
                      <span className="font-semibold">5 tỷ VNĐ</span>
                    </div>
                    <div className="flex justify-between">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
                    <User className="w-5 h-5 mr-2 text-vp-green" />
                    Hỗ Trợ Khách Hàng
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="font-semibold text-vp-green">1900 545415</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Email:</p>
                      <p className="font-semibold">support@vpbank.com.vn</p>
                    </div>
                    <div>
