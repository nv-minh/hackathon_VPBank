          ...
          <div className="space-y-6 lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Quản lý các khoản vay và theo dõi trạng thái đăng ký của bạn
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Theo dõi các giao dịch và thanh toán của bạn
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            {isLoadingProfile ? (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Tôi có thể giúp bạn đăng ký khoản vay
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ChatBot onClose={() => {}} />
